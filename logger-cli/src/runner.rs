        ...
        let app_event = match script_event.clone() {
            ...
            ScriptEvent::Key { key } => Some(AppEvent::KeyPress {
                key: match key {
                    ...
                    KeyValue::F8 => Key::F8,
                    KeyValue::F9 => Key::F9,
                    KeyValue::F12 => Key::F12,
                    KeyValue::Enter => Key::Enter,
                    KeyValue::Equal => Key::Equal,
                    KeyValue::CtrlAltF1 => Key::CtrlAltF1,
                    KeyValue::CtrlAltF2 => Key::CtrlAltF2,
                    KeyValue::CtrlAltF3 => Key::CtrlAltF3,
                    KeyValue::CtrlAltF4 => Key::CtrlAltF4,
                    KeyValue::CtrlAltF5 => Key::CtrlAltF5,
                    KeyValue::CtrlAltF6 => Key::CtrlAltF6,
                    KeyValue::CtrlAltF7 => Key::CtrlAltF7,
                    KeyValue::CtrlAltF8 => Key::CtrlAltF8,
                    KeyValue::CtrlAltF9 => Key::CtrlAltF9,
                    KeyValue::CtrlAltF10 => Key::CtrlAltF10,
                    KeyValue::CtrlAltF11 => Key::CtrlAltF11,
                    KeyValue::CtrlAltF12 => Key::CtrlAltF12,
                },
            }),
...
mod tests {
    ...
    fn run_all_golden_scripts() {
        ...
        let scripts = [
            ...
            "ns_sprint_auto_toggle.json",
            "ns_sprint_ctrl_alt_macro_claims_serial.json",
            "ns_sprint_f2_before_enter_claims_serial.json",
            "ns_sprint_f12_rolls_back_serial.json",
            "ns_sprint_run_keystroke_reserves_serial.json",
            "ns_sprint_sp_cursor_leave_reserves_serial.json",
            "ns_sprint_sp_no_tab_no_reservation.json",
        ];
